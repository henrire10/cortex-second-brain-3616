...
-- Corrigir a função handle_new_user para resolver o erro de signup
...
AS $$
BEGIN
  -- Inserir na tabela profiles usando new.id como id e user_id
  INSERT INTO public.profiles (id, user_id, name, email, created_at, updated_at)
  VALUES (
    new.id,
    new.id,  -- user_id deve ser igual ao id
